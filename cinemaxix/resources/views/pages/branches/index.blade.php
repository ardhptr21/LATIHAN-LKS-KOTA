@extends('layouts.app', ['title' => 'Branches'])
...
@section('content')
    <section class="p-10">
        ...
        <div class="flex w-full gap-14 justify-center items-start">
                    ...
                    <tbody>
                        @foreach ($branches as $branch)
                            <tr
                                ...
                                <td class="px-6 py-4">
                                    {{ $branch->studios_count }}
                                </td>
                                <td class="px-6 py-4 space-x-3 inline-flex items-center">
                                    <a href="?edit={{ $branch->id }}" type="button"
            ...
            <form class="w-96" method="POST" action="{{ route('branches.store') }}">
                @csrf
                <h3 class="text-3xl font-bold dark:text-white mb-5">New Branch</h3>
                <div class="mb-6">
                    ...
                    <input type="name" id="name" name="name"
                        ...
                        placeholder="Semarang" value="{{ old('name') }}" required autocomplete="off">
                    @error('name')
                ...
                @endif
                <button type="submit"
                    class="text-white bg-blue-700 w-full hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
            </form>
        </div>
    </section>
@endsection
