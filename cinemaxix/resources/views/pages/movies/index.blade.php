@extends('layouts.app', ['title' => 'Create New Movie'])
    ...
    <section class="p-10">
        <div class="mb-10 inline-flex justify-between items-center w-full">
            ...
            <button
                ...
                type="button" data-drawer-target="drawer-new-movie" data-drawer-show="drawer-new-movie"
                aria-controls="drawer-new-movie">
                New Movie
            </button>
        </div>
            ...
            <div class="w-full grid grid-cols-4 gap-5 mx-auto">
                @foreach ($movies as $movie)
                    <div
                        ...
                        <div class="inline-flex justify-center w-full mb-5 gap-5">
                            <a href="?edit={{ $movie->id }}" type="button"
                                class="text-yellow-500 p-1 hover:bg-yellow-100 rounded"><svg
                            ...
                            <form action="{{ route('movies.destroy', $movie) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-700 p-1 hover:bg-red-100 rounded"><svg
        ...
        <div id="drawer-new-movie"
            class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800"
            tabindex="-1" aria-labelledby="drawer-new-movie-label">
            <h5 id="drawer-label"
                class="inline-flex items-center mb-6 text-base font-semibold text-gray-500 uppercase dark:text-gray-400">
                New
                Movie</h5>
            <button type="button" data-drawer-hide="drawer-new-movie" aria-controls="drawer-new-movie"
            ...
            <form action="{{ route('movies.store') }}" class="mb-6" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-6">
                    <label for="name"
                    ...
                    <input type="text" id="name" name="name"
                        ...
                        placeholder="Power Rangers" required>
                </div>
                <div class="mb-6">
                    ...
                    <input type="number" id="minute_length" name="minute_length" min="1" max="999"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="1 - 999 Minutes" required>
                </div>
                <div class="mb-6">
